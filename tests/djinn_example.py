...
print("djinn example")    
modelname="djinn_test"   # name the model
...
model.train(x_train,y_train,epochs=epochs,learn_rate=learnrate, batch_size=batchsize, 
              display_step=1, save_files=True, file_name="djinn_test_files", 
